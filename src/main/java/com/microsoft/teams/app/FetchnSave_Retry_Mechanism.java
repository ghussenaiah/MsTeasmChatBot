					...
					if (message.body.content != null && message.attachments.size() == 0) {
						...
						jdbcTemplate.update(
								"insert into chathistory_299 (id, message, senderid, teamsmessageid,createtime) VALUES ("
										+ chatId + ",'" + actualmessage + "','" + fromuser + "','" + messgeId + "','"
										+ date + "')");
						jdbcTemplate.update(
								"insert into ticket_296__chathistory_299 (ticket_296id, chathistory_299id) VALUES ("
										+ tkt.getId() + "," + chatId + ")");
						...
						for (ChatMessageAttachment cmA : chatMsgAttachList) {
							...
							String downloadLink = "https://135.181.202.86:12002/kagami-generated_Srinivasa_Live/dms/downloadDocument?docId=1654509082354";
							...
							File packageFile = new File("/home/husenaiah/Downloads/avadhootTemplates/employee.png");
